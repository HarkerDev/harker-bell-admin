  ...
  <v-container>
    <v-row>
      ...
      <v-col cols="12" sm="8" md="4" lg="3" xl="2">
        ...
        <v-select v-model="selectedPreset.variant" clearable dense :disabled="presets.length == 0" :items="['adjusted', 'special', 'unofficial', 'unverified']" placeholder="Special/Adjusted/Other" prepend-icon="flag"></v-select>
        <v-divider></v-divider>
